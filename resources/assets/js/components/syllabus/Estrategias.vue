<template>
    <div>
        <h1>{{ titulo }}
            <span v-if="!switchEdit && active_line == 0 && nuevo.estrategias ">
    ...
    export default {
        ...
        methods: {
            ...
            borrar(linea) {
                ...
                if(check) {
                    toastr.success('Estrategias eliminadas.');
                }
            },
            consistencia(linea){
                toastr.closeButton = false;
                ...
                if(check.trim().length > 0){
                    ...
                    mess = 'Inserte el texto ESTRATEGIAS.';
                }
                if(consistencia == 1){
                    return true;
                }else{
            ...
            recalcRow(oldLinea){
                ...
                var titulo = this.lineas.filter((linea) => linea.tipo == 'titulo1' && linea.subtipo == 'estrategias');
